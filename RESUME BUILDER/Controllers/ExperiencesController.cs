...
namespace RESUME_BUILDER.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        {
            var resumeContext = _context.Experiences.Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("Id,Role,Company,StudentId")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Role,Company,StudentId")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ResumeContext.Experiences'  is null.");
            }
            var experience = await _context.Experiences.FindAsync(id);
            if (experience != null)
            {
